...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            {{ Form::open(['method' => 'put', 'name' => 'formLogin', 'url' => "/noticia/update/{$getNoticia->id}", 'enctype' => 'multipart/form-data']) }}
            <fieldset>
                <legend>Dados</legend>
                <div class="row">
                    <div class="col-md-4">
                        <input class="form-control" placeholder="Título" name="titulo" type="text" autofocus=""
                            value="{{ $getNoticia->title }}">
                    ...
                    <div class="col-md-3">
                        <select name="estado" class="form-control">
                            <option value="{{ $getNoticia->estado }}" hidden>{{ $getNoticia->estado }}</option>
                    ...
                    <div class="col-md-12">
                        <input class="form-control" placeholder="Rescalgo da Noticia" name="description_min" type="text"
                            autofocus="" value="{{ $getNoticia->description_min }}">
